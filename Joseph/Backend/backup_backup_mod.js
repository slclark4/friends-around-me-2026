...
export async function submitUserData(userData, userID = null) {
  /**
   * Submits user data to the database (inserts if new, updates if ID is provided)
   * @param {Object} userData - User data object containing location and school info
   * @param {string} userData.full_name - Full name of the user
   * @param {string} userData.highschool_name - Name of the user's high school
   * @param {number} userData.highschool_lat - Latitude of the user's high school
   * @param {number} userData.highschool_lon - Longitude of the user's high school
   * @param {string} userData.mis1_name - Name of the first mission city
   * @param {number} userData.mis1_lat - Latitude of the first mission city
   * @param {number} userData.mis1_lon - Longitude of the first mission city
   * @param {string} userData.mis2_name - Name of the second mission city
   * @param {number} userData.mis2_lat - Latitude of the second mission city
   * @param {number} userData.mis2_lon - Longitude of the second mission city
   * @param {number|null} userID - The ID of the user to update, or null to insert a new row
   * @returns {Promise<number|null>} The ID of the inserted/updated user, or null if error
   */
  const fields = {
  ...
  // if user ID is not passed with the data, then it will insert the
  // data as a new row
  if (userID == null) {
